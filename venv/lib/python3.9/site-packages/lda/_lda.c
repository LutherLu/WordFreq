 ...
 */
              __pyx_t_8 = __pyx_v_k;
              __pyx_t_4 = __pyx_v_w;
              __pyx_v_ll = (__pyx_v_ll + (__pyx_f_3lda_4_lda_lgamma((__pyx_v_eta + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_8 * __pyx_v_nzw.strides[0]) ) + __pyx_t_4 * __pyx_v_nzw.strides[1]) ))))) - __pyx_v_lgamma_eta));
 ...
 */
              __pyx_t_8 = __pyx_v_d;
              __pyx_t_4 = __pyx_v_k;
              __pyx_v_ll = (__pyx_v_ll + (__pyx_f_3lda_4_lda_lgamma((__pyx_v_alpha + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_8 * __pyx_v_ndz.strides[0]) ) + __pyx_t_4 * __pyx_v_ndz.strides[1]) ))))) - __pyx_v_lgamma_alpha));
